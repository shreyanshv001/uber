...
function VehiclePanel({ setconfirmRidePanel, setvehiclePanel }) {
  return (
    <div>
      ...
      <div
        ...
        className="flex justify-evenly px-1 py-3 mb-2 items-center gap-2 border-2 w-full active:border-black rounded-md "
      >
        <img
          ...
          alt=""
        />
        <div className="leading-tight w-[45%]">
          <h4 className="font-semibold">
            UberGo{" "}
            <span>
              <i className="ri-user-fill font-normal">4</i>
            </span>
          </h4>
          <h5 className="text-sm">2 mins away</h5>
          <p className="text-zinc-600 text-xs">Affordable, compact rides</p>
        </div>
        <h1 className="font-semibold text-xl  ">₹193.20</h1>
      </div>
      <div
        onClick={() => {
          setconfirmRidePanel(true);
        }}
        className="flex justify-evenly mb-2 items-center px-1 py-3 gap-2 border-2 w-full active:border-black rounded-md "
      >
        <img
          className="w-20 object-cover"
        ...
        <div className="leading-tight w-[45%]">
          <h4 className="font-semibold">
            Moto{" "}
            <span>
              <i className="ri-user-fill font-normal">1</i>
            </span>
          </h4>
          <h5 className="text-sm">3 mins away</h5>
          <p className="text-zinc-600 text-xs">Affordable motocycle rides</p>
        </div>
        <h1 className="font-semibold text-xl  ">₹65.03</h1>
      </div>
      <div
        onClick={() => {
          setconfirmRidePanel(true);
      ...
      >
        ...
        <div className="leading-tight w-[45%] ">
          <h4 className="font-semibold ">
            UberAuto{" "}
            <span>
              <i className="ri-user-fill font-normal">3</i>
            </span>
          </h4>
          <h5 className="text-sm">2 mins away</h5>
          <p className="text-zinc-600 text-xs">Affordable auto rides</p>
        </div>
        <h1 className="font-semibold text-xl  ">₹113.11</h1>
      </div>
    </div>
  );
}
